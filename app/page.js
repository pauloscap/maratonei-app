...
const baseSeries = [
  ...
  { id: 103, titulo: "Off Campus", ano: "2025", status: "assistindo", img: "https://picsum.photos/seed/offcampus/400/600" },
  { id: 104, titulo: "The Walking Dead", ano: "2010", status: "assistindo", img: "https://picsum.photos/seed/twd/400/600" },
  { id: 201, titulo: "Elle", ano: "2025", status: "ja_assisti", img: "https://picsum.photos/seed/elle/400/600" },
    ...
    <div style={{ minHeight: "100vh", background: "#0A0F2A", color: "#fff", paddingBottom: 90 }}>
      <header style={{ height: 56, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 14px", borderBottom: "1px solid #ffffff0f", position: "sticky", top: 0, background: "#0A0F2A", zIndex: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{ width: 28, height: 28, borderRadius: 8, background: "#FFD400", color: "#000", display: "grid", placeItems: "center", fontWeight: 900 }}>M</div>
          <b>maratonei</b>
        </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: 14 }}>
        <div style={{ background: "#121A3A", border: "1px solid #ffffff12", borderRadius: 999, display: "flex", alignItems: "center", padding: "0 14px", height: 42, maxWidth: 420, margin: "0 auto" }}>
          ...
          <input value={busca} onChange={(e) => setBusca(e.target.value)} placeholder="Buscar serie para adicionar..." style={{ flex: 1, background: "transparent", border: 0, outline: "none", color: "#fff", fontSize: 13 }} />
        </div>
