  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        <div className="mt-12 bg-[#151a2d] rounded-2xl p-2 border border-white/10 shadow-2xl max-w-3xl mx-auto">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-6">
        <div className="bg-[#151a2d] p-6 rounded-2xl border border-white/5">
          <h3 className="font-bold text-lg mb-2">Sua Watchlist em um lugar</h3>
          <p className="text-slate-400 text-sm">Salve filmes e séries que quer assistir, marque como visto e nunca mais esqueça.</p>
        </div>
        <div className="bg-[#151a2d] p-6 rounded-2xl border border-white/5">
          <h3 className="font-bold text-lg mb-2">Acompanhe seu progresso</h3>
          <p className="text-slate-400 text-sm">Veja quantos filmes por pessoa, média por usuário e seus gêneros favoritos.</p>
        </div>
        <div className="bg-[#151a2d] p-6 rounded-2xl border border-white/5">
          <h3 className="font-bold text-lg mb-2">Top da galera</h3>
          <p className="text-slate-400 text-sm">Descubra o que todo mundo está maratonando agora no Maratonei.</p>
        </div>
      </div>
